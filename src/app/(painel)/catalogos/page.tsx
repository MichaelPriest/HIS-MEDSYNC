  ...
  return <SectionPage eyebrow="Cadastros / Catálogos" title="Catálogos assistenciais" description="Códigos e descrições centralizados para os módulos do HIS." primaryActionLabel="Novo item" primaryActionHref="/catalogos/novo">
    ...
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm shadow-slate-900/[0.03]">
      <div className="flex flex-col gap-3 border-b border-slate-100 p-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-brand-50 text-brand-700"><BookOpenCheck className="size-5" /></span><div><h2 className="font-semibold text-slate-900">Itens ativos</h2><p className="text-sm text-slate-500">Domínios e referências centralizados do HIS.</p></div></div>
