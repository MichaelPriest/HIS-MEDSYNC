...
export default async function DiretoriaPage(){
  ...
  return <SectionPage eyebrow="Gestão / Diretoria" title="Painel da Diretoria" description="Visão executiva consolidada de assistência, receita, despesas, auditoria e ciclo financeiro.">
