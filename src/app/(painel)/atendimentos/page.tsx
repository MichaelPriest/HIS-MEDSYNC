...
export default async function AtendimentosPage({ searchParams }: { searchParams: Promise<{ sucesso?: string; q?: string }> }) {
  ...
  return <SectionPage eyebrow="Assistencial / Atendimento" title="Atendimento / ADT" description="Localize por nº do atendimento, nome do paciente, CPF, CNS, RA ou número de registro." primaryActionLabel="Abrir atendimento" primaryActionHref="/atendimentos/novo">
