...
type Chamada = { senha?: string; nome_chamada?: string | null; identificado?: boolean; setor_nome?: string; ponto_atendimento?: string; ultima_chamada_em?: string };
...
export default async function PainelChamadasPage({ params }: { params: Promise<{ unidadeId: string }> }) {
  ...
  const chamadas = (Array.isArray(data) ? data : []) as Chamada[];
