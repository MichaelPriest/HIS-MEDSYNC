...
export const commercialLinkKnowledgeBaseArticles: KnowledgeBaseArticle[] = [
  {
    ...
    steps: [
      ...
      "Consulte Histórico comercial para conferir mudanças de contrato, vínculo, regras, DePara, fontes e edições e, depois, execute novamente Prontidão, Simulador, Matriz de cenários e Homologação quando a configuração vigente tiver sido alterada.",
    ],
    warnings: [
