...
export async function salvarItemEdicaoComercial(formData: FormData) {
  ...
  const payload = {
    ...
    quantidade_auxiliares: numeric(text(formData, "quantidade_auxiliares")),
    ch_anestesista: numeric(text(formData, "ch_anestesista")),
    quantidade_filme: numeric(text(formData, "quantidade_filme")),
