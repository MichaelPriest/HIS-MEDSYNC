...
const personalPathsBySector: Record<string, readonly string[]> = {
  ...
  faturamento: ["/faturamento", "/faturamento/producao", "/faturamento/lotes", "/faturamento/glosas", "/contas-medicas", "/central-guias"],
  financeiro: ["/financeiro", "/financeiro/notas-fiscais", "/faturamento", "/ged"],
  auditoria: ["/auditoria", "/contas-medicas", "/faturamento", "/ged"],
  ...
  rh: ["/rh", "/ged"],
  seguranca: ["/seguranca"],
  ti: ["/ti", "/configuracoes/acessos", "/configuracoes/estrutura"],
