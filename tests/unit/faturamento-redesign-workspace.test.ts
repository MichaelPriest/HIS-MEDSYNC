...
describe("workspace do ciclo da receita", () => {
  it("mantém navegação única e modal acessível", () => {
    ...
    for (const label of ["Visão geral", "Produção", "Guias TISS", "Lotes", "Glosas", "Recursos", "Recebíveis", "Notas fiscais"]) {
